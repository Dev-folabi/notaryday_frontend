          ...
          <div className="mb-6 p-4 bg-primary-navy rounded-20px text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-inter text-[10px] font-bold uppercase tracking-wider text-pro-gold">Pro Engine</span>
              </div>
              <div className="font-sora font-bold text-sm mb-1 leading-tight">Gap Finder & Route Optimisation</div>
              <p className="font-inter text-[10px] text-white/50 mb-4 leading-relaxed">Increase your net profit by up to 24% per day.</p>
              <Link 
        ...
        {username && (
          <div className="flex items-center gap-3 mb-2 px-1">
            ...
            <div className="flex flex-col">
              <span className="font-inter text-xs font-bold text-primary-navy truncate max-w-[120px]">@{username}</span>
              <span className="font-inter text-[10px] text-slate-secondary font-medium">Standard Account</span>
            </div>
